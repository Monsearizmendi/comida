            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav ml-auto">
                        ...
                        <a href="{{route('equipo')}}" class="nav-item nav-link active">Team</a>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="footer-contact">
                                    <h2>Our Address</h2>
                                    <p><i class="fa fa-phone-alt"></i>+55 458 452 412</p>
                                    <p><i class="fa fa-envelope"></i>monse2012018@gmail.com</p>
